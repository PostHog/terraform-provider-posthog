...
`func NewConversiongoal(actionId int32, customEventName string, ) *Conversiongoal`
...
`func (o *Conversiongoal) GetActionId() int32`

GetActionId returns the ActionId field if non-nil, zero value otherwise.

### GetActionIdOk

`func (o *Conversiongoal) GetActionIdOk() (*int32, bool)`
...
`func (o *Conversiongoal) SetActionId(v int32)`
...
`func (o *Conversiongoal) SetCustomEventName(v string)`
