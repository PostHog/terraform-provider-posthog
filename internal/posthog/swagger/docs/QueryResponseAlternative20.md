...
### NewQueryResponseAlternative20WithDefaults
...
`func (o *QueryResponseAlternative20) SetBreakdownResultsNil(b bool)`

 SetBreakdownResultsNil sets the value for BreakdownResults to be an explicit nil

### UnsetBreakdownResults
`func (o *QueryResponseAlternative20) UnsetBreakdownResults()`
...
`func (o *QueryResponseAlternative20) SetCredibleIntervalsNil(b bool)`

 SetCredibleIntervalsNil sets the value for CredibleIntervals to be an explicit nil

### UnsetCredibleIntervals
`func (o *QueryResponseAlternative20) UnsetCredibleIntervals()`
...
`func (o *QueryResponseAlternative20) SetInsightNil(b bool)`

 SetInsightNil sets the value for Insight to be an explicit nil

### UnsetInsight
`func (o *QueryResponseAlternative20) UnsetInsight()`
...
`func (o *QueryResponseAlternative20) SetMetricNil(b bool)`
...
`func (o *QueryResponseAlternative20) SetPValueNil(b bool)`
...
`func (o *QueryResponseAlternative20) SetProbabilityNil(b bool)`

 SetProbabilityNil sets the value for Probability to be an explicit nil

### UnsetProbability
`func (o *QueryResponseAlternative20) UnsetProbability()`
...
`func (o *QueryResponseAlternative20) SetSignificantNil(b bool)`
...
`func (o *QueryResponseAlternative20) SetStatsVersionNil(b bool)`
...
`func (o *QueryResponseAlternative20) SetVariantResultsNil(b bool)`
...
`func (o *QueryResponseAlternative20) SetVariantsNil(b bool)`
