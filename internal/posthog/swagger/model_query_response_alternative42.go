...
// checks if the QueryResponseAlternative42 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryResponseAlternative42{}

// QueryResponseAlternative42 struct for QueryResponseAlternative42
...
type _QueryResponseAlternative42 QueryResponseAlternative42
...
func NewQueryResponseAlternative42(results []interface{}) *QueryResponseAlternative42 {
	this := QueryResponseAlternative42{}
...
func (o *QueryResponseAlternative42) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *QueryResponseAlternative42) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o *QueryResponseAlternative42) SetHogqlNil() {
	o.Hogql.Set(nil)
}
...
func (o *QueryResponseAlternative42) SetLimitNil() {
	o.Limit.Set(nil)
}
...
func (o *QueryResponseAlternative42) SetOffsetNil() {
	o.Offset.Set(nil)
}
...
func (o *QueryResponseAlternative42) SetUsedPreAggregatedTablesNil() {
...
func (o QueryResponseAlternative42) MarshalJSON() ([]byte, error) {
...
func (o QueryResponseAlternative42) ToMap() (map[string]interface{}, error) {
...
func (o *QueryResponseAlternative42) UnmarshalJSON(data []byte) (err error) {
	...
	varQueryResponseAlternative42 := _QueryResponseAlternative42{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varQueryResponseAlternative42)

	if err != nil {
		return err
	}

	*o = QueryResponseAlternative42(varQueryResponseAlternative42)

	return err
}

type NullableQueryResponseAlternative42 struct {
	value *QueryResponseAlternative42
	isSet bool
}

func (v NullableQueryResponseAlternative42) Get() *QueryResponseAlternative42 {
	return v.value
}

func (v *NullableQueryResponseAlternative42) Set(val *QueryResponseAlternative42) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryResponseAlternative42) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryResponseAlternative42) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryResponseAlternative42(val *QueryResponseAlternative42) *NullableQueryResponseAlternative42 {
	return &NullableQueryResponseAlternative42{value: val, isSet: true}
}

func (v NullableQueryResponseAlternative42) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryResponseAlternative42) UnmarshalJSON(src []byte) error {
	v.isSet = true
