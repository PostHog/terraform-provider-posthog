...
// checks if the Response3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Response3{}
...
func (o *Response3) SetClickhouseNil() {
...
func (o *Response3) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o Response3) ToMap() (map[string]interface{}, error) {
...
func (o *Response3) UnmarshalJSON(data []byte) (err error) {
	...
	varResponse3 := _Response3{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponse3)

	if err != nil {
		return err
	}

	*o = Response3(varResponse3)
