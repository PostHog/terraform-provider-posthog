...
// checks if the QueryResponseAlternative17 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryResponseAlternative17{}

// QueryResponseAlternative17 struct for QueryResponseAlternative17
...
type _QueryResponseAlternative17 QueryResponseAlternative17
...
func NewQueryResponseAlternative17(results []ErrorTrackingCorrelatedIssue) *QueryResponseAlternative17 {
	this := QueryResponseAlternative17{}
...
func (o *QueryResponseAlternative17) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *QueryResponseAlternative17) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o *QueryResponseAlternative17) SetHogqlNil() {
	o.Hogql.Set(nil)
}
...
func (o *QueryResponseAlternative17) SetLimitNil() {
	o.Limit.Set(nil)
}
...
func (o *QueryResponseAlternative17) SetOffsetNil() {
	o.Offset.Set(nil)
}
...
func (o QueryResponseAlternative17) MarshalJSON() ([]byte, error) {
...
func (o QueryResponseAlternative17) ToMap() (map[string]interface{}, error) {
...
func (o *QueryResponseAlternative17) UnmarshalJSON(data []byte) (err error) {
	...
	varQueryResponseAlternative17 := _QueryResponseAlternative17{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varQueryResponseAlternative17)

	if err != nil {
		return err
	}

	*o = QueryResponseAlternative17(varQueryResponseAlternative17)

	return err
}

type NullableQueryResponseAlternative17 struct {
	value *QueryResponseAlternative17
	isSet bool
}

func (v NullableQueryResponseAlternative17) Get() *QueryResponseAlternative17 {
	return v.value
}

func (v *NullableQueryResponseAlternative17) Set(val *QueryResponseAlternative17) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryResponseAlternative17) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryResponseAlternative17) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryResponseAlternative17(val *QueryResponseAlternative17) *NullableQueryResponseAlternative17 {
	return &NullableQueryResponseAlternative17{value: val, isSet: true}
}

func (v NullableQueryResponseAlternative17) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryResponseAlternative17) UnmarshalJSON(src []byte) error {
	v.isSet = true
