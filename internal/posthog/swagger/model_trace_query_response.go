...
// checks if the TraceQueryResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TraceQueryResponse{}
...
type _TraceQueryResponse TraceQueryResponse
...
func (o *TraceQueryResponse) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *TraceQueryResponse) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o *TraceQueryResponse) SetHogqlNil() {
	o.Hogql.Set(nil)
}
...
func (o *TraceQueryResponse) SetLimitNil() {
	o.Limit.Set(nil)
}
...
func (o *TraceQueryResponse) SetOffsetNil() {
	o.Offset.Set(nil)
}
...
func (o TraceQueryResponse) ToMap() (map[string]interface{}, error) {
...
func (o *TraceQueryResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varTraceQueryResponse := _TraceQueryResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTraceQueryResponse)

	if err != nil {
		return err
	}

	*o = TraceQueryResponse(varTraceQueryResponse)
