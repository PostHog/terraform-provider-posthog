...
// checks if the Response9 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Response9{}

// Response9 struct for Response9
...
func (o *Response9) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o Response9) MarshalJSON() ([]byte, error) {
...
func (o Response9) ToMap() (map[string]interface{}, error) {
...
func (o *Response9) UnmarshalJSON(data []byte) (err error) {
	...
	varResponse9 := _Response9{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponse9)

	if err != nil {
		return err
	}

	*o = Response9(varResponse9)

	return err
}

type NullableResponse9 struct {
	value *Response9
	isSet bool
}

func (v NullableResponse9) Get() *Response9 {
	return v.value
}

func (v *NullableResponse9) Set(val *Response9) {
	v.value = val
	v.isSet = true
}

func (v NullableResponse9) IsSet() bool {
	return v.isSet
}

func (v *NullableResponse9) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponse9(val *Response9) *NullableResponse9 {
	return &NullableResponse9{value: val, isSet: true}
}

func (v NullableResponse9) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponse9) UnmarshalJSON(src []byte) error {
	v.isSet = true
