...
// checks if the QueryResponseAlternative35 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryResponseAlternative35{}

// QueryResponseAlternative35 struct for QueryResponseAlternative35
...
type _QueryResponseAlternative35 QueryResponseAlternative35
...
func NewQueryResponseAlternative35(results [][]MarketingAnalyticsItem) *QueryResponseAlternative35 {
	this := QueryResponseAlternative35{}
...
func (o *QueryResponseAlternative35) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *QueryResponseAlternative35) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o *QueryResponseAlternative35) SetHogqlNil() {
	o.Hogql.Set(nil)
}
...
func (o *QueryResponseAlternative35) SetLimitNil() {
	o.Limit.Set(nil)
}
...
func (o *QueryResponseAlternative35) SetOffsetNil() {
	o.Offset.Set(nil)
}
...
func (o QueryResponseAlternative35) MarshalJSON() ([]byte, error) {
...
func (o QueryResponseAlternative35) ToMap() (map[string]interface{}, error) {
...
func (o *QueryResponseAlternative35) UnmarshalJSON(data []byte) (err error) {
	...
	varQueryResponseAlternative35 := _QueryResponseAlternative35{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varQueryResponseAlternative35)

	if err != nil {
		return err
	}

	*o = QueryResponseAlternative35(varQueryResponseAlternative35)

	return err
}

type NullableQueryResponseAlternative35 struct {
	value *QueryResponseAlternative35
	isSet bool
}

func (v NullableQueryResponseAlternative35) Get() *QueryResponseAlternative35 {
	return v.value
}

func (v *NullableQueryResponseAlternative35) Set(val *QueryResponseAlternative35) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryResponseAlternative35) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryResponseAlternative35) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryResponseAlternative35(val *QueryResponseAlternative35) *NullableQueryResponseAlternative35 {
	return &NullableQueryResponseAlternative35{value: val, isSet: true}
}

func (v NullableQueryResponseAlternative35) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryResponseAlternative35) UnmarshalJSON(src []byte) error {
	v.isSet = true
