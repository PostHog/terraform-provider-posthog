...
// checks if the Response21 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Response21{}

// Response21 struct for Response21
...
func (o *Response21) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o *Response21) SetOffsetNil() {
	o.Offset.Set(nil)
}
...
func (o Response21) MarshalJSON() ([]byte, error) {
...
func (o Response21) ToMap() (map[string]interface{}, error) {
...
func (o *Response21) UnmarshalJSON(data []byte) (err error) {
	...
	varResponse21 := _Response21{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponse21)

	if err != nil {
		return err
	}

	*o = Response21(varResponse21)

	return err
}

type NullableResponse21 struct {
	value *Response21
	isSet bool
}

func (v NullableResponse21) Get() *Response21 {
	return v.value
}

func (v *NullableResponse21) Set(val *Response21) {
	v.value = val
	v.isSet = true
}

func (v NullableResponse21) IsSet() bool {
	return v.isSet
}

func (v *NullableResponse21) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponse21(val *Response21) *NullableResponse21 {
	return &NullableResponse21{value: val, isSet: true}
}

func (v NullableResponse21) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponse21) UnmarshalJSON(src []byte) error {
	v.isSet = true
