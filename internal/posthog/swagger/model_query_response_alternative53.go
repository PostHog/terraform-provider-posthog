...
// checks if the QueryResponseAlternative53 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryResponseAlternative53{}

// QueryResponseAlternative53 struct for QueryResponseAlternative53
...
type _QueryResponseAlternative53 QueryResponseAlternative53
...
func NewQueryResponseAlternative53(results interface{}) *QueryResponseAlternative53 {
	this := QueryResponseAlternative53{}
...
func (o *QueryResponseAlternative53) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *QueryResponseAlternative53) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o *QueryResponseAlternative53) SetHogqlNil() {
	o.Hogql.Set(nil)
}
...
func (o *QueryResponseAlternative53) SetLimitNil() {
	o.Limit.Set(nil)
}
...
func (o *QueryResponseAlternative53) SetOffsetNil() {
	o.Offset.Set(nil)
}
...
func (o QueryResponseAlternative53) MarshalJSON() ([]byte, error) {
...
func (o QueryResponseAlternative53) ToMap() (map[string]interface{}, error) {
...
func (o *QueryResponseAlternative53) UnmarshalJSON(data []byte) (err error) {
	...
	varQueryResponseAlternative53 := _QueryResponseAlternative53{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varQueryResponseAlternative53)

	if err != nil {
		return err
	}

	*o = QueryResponseAlternative53(varQueryResponseAlternative53)

	return err
}

type NullableQueryResponseAlternative53 struct {
	value *QueryResponseAlternative53
	isSet bool
}

func (v NullableQueryResponseAlternative53) Get() *QueryResponseAlternative53 {
	return v.value
}

func (v *NullableQueryResponseAlternative53) Set(val *QueryResponseAlternative53) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryResponseAlternative53) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryResponseAlternative53) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryResponseAlternative53(val *QueryResponseAlternative53) *NullableQueryResponseAlternative53 {
	return &NullableQueryResponseAlternative53{value: val, isSet: true}
}

func (v NullableQueryResponseAlternative53) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryResponseAlternative53) UnmarshalJSON(src []byte) error {
	v.isSet = true
