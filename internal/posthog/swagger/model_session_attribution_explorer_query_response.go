...
// checks if the SessionAttributionExplorerQueryResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SessionAttributionExplorerQueryResponse{}

// SessionAttributionExplorerQueryResponse struct for SessionAttributionExplorerQueryResponse
...
type _SessionAttributionExplorerQueryResponse SessionAttributionExplorerQueryResponse
...
func NewSessionAttributionExplorerQueryResponse(results interface{}) *SessionAttributionExplorerQueryResponse {
	this := SessionAttributionExplorerQueryResponse{}
...
func (o *SessionAttributionExplorerQueryResponse) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *SessionAttributionExplorerQueryResponse) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o *SessionAttributionExplorerQueryResponse) SetHogqlNil() {
	o.Hogql.Set(nil)
}
...
func (o *SessionAttributionExplorerQueryResponse) SetLimitNil() {
	o.Limit.Set(nil)
}
...
func (o *SessionAttributionExplorerQueryResponse) SetOffsetNil() {
	o.Offset.Set(nil)
}
...
func (o SessionAttributionExplorerQueryResponse) MarshalJSON() ([]byte, error) {
...
func (o SessionAttributionExplorerQueryResponse) ToMap() (map[string]interface{}, error) {
...
func (o *SessionAttributionExplorerQueryResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSessionAttributionExplorerQueryResponse := _SessionAttributionExplorerQueryResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSessionAttributionExplorerQueryResponse)

	if err != nil {
		return err
	}

	*o = SessionAttributionExplorerQueryResponse(varSessionAttributionExplorerQueryResponse)

	return err
}

type NullableSessionAttributionExplorerQueryResponse struct {
	value *SessionAttributionExplorerQueryResponse
	isSet bool
}

func (v NullableSessionAttributionExplorerQueryResponse) Get() *SessionAttributionExplorerQueryResponse {
	return v.value
}

func (v *NullableSessionAttributionExplorerQueryResponse) Set(val *SessionAttributionExplorerQueryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSessionAttributionExplorerQueryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSessionAttributionExplorerQueryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSessionAttributionExplorerQueryResponse(val *SessionAttributionExplorerQueryResponse) *NullableSessionAttributionExplorerQueryResponse {
	return &NullableSessionAttributionExplorerQueryResponse{value: val, isSet: true}
}

func (v NullableSessionAttributionExplorerQueryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSessionAttributionExplorerQueryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
