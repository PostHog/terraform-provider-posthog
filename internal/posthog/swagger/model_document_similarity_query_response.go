...
// checks if the DocumentSimilarityQueryResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DocumentSimilarityQueryResponse{}

// DocumentSimilarityQueryResponse struct for DocumentSimilarityQueryResponse
...
type _DocumentSimilarityQueryResponse DocumentSimilarityQueryResponse
...
func NewDocumentSimilarityQueryResponse(results []EmbeddingDistance) *DocumentSimilarityQueryResponse {
	this := DocumentSimilarityQueryResponse{}
...
func (o *DocumentSimilarityQueryResponse) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *DocumentSimilarityQueryResponse) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o *DocumentSimilarityQueryResponse) SetHogqlNil() {
	o.Hogql.Set(nil)
}
...
func (o *DocumentSimilarityQueryResponse) SetLimitNil() {
	o.Limit.Set(nil)
}
...
func (o *DocumentSimilarityQueryResponse) SetOffsetNil() {
	o.Offset.Set(nil)
}
...
func (o DocumentSimilarityQueryResponse) MarshalJSON() ([]byte, error) {
...
func (o DocumentSimilarityQueryResponse) ToMap() (map[string]interface{}, error) {
...
func (o *DocumentSimilarityQueryResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDocumentSimilarityQueryResponse := _DocumentSimilarityQueryResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDocumentSimilarityQueryResponse)

	if err != nil {
		return err
	}

	*o = DocumentSimilarityQueryResponse(varDocumentSimilarityQueryResponse)

	return err
}

type NullableDocumentSimilarityQueryResponse struct {
	value *DocumentSimilarityQueryResponse
	isSet bool
}

func (v NullableDocumentSimilarityQueryResponse) Get() *DocumentSimilarityQueryResponse {
	return v.value
}

func (v *NullableDocumentSimilarityQueryResponse) Set(val *DocumentSimilarityQueryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDocumentSimilarityQueryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDocumentSimilarityQueryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDocumentSimilarityQueryResponse(val *DocumentSimilarityQueryResponse) *NullableDocumentSimilarityQueryResponse {
	return &NullableDocumentSimilarityQueryResponse{value: val, isSet: true}
}

func (v NullableDocumentSimilarityQueryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDocumentSimilarityQueryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
