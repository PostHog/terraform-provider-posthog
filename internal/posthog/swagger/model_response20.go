...
// checks if the Response20 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Response20{}

// Response20 struct for Response20
...
func (o *Response20) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o *Response20) SetOffsetNil() {
	o.Offset.Set(nil)
}
...
func (o Response20) MarshalJSON() ([]byte, error) {
...
func (o Response20) ToMap() (map[string]interface{}, error) {
...
func (o *Response20) UnmarshalJSON(data []byte) (err error) {
	...
	varResponse20 := _Response20{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponse20)

	if err != nil {
		return err
	}

	*o = Response20(varResponse20)

	return err
}

type NullableResponse20 struct {
	value *Response20
	isSet bool
}

func (v NullableResponse20) Get() *Response20 {
	return v.value
}

func (v *NullableResponse20) Set(val *Response20) {
	v.value = val
	v.isSet = true
}

func (v NullableResponse20) IsSet() bool {
	return v.isSet
}

func (v *NullableResponse20) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponse20(val *Response20) *NullableResponse20 {
	return &NullableResponse20{value: val, isSet: true}
}

func (v NullableResponse20) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponse20) UnmarshalJSON(src []byte) error {
	v.isSet = true
