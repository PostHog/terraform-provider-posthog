...
// checks if the WebTrendsQueryResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebTrendsQueryResponse{}

// WebTrendsQueryResponse struct for WebTrendsQueryResponse
type WebTrendsQueryResponse struct {
	...
	Results []WebTrendsItem `json:"results"`
...
type _WebTrendsQueryResponse WebTrendsQueryResponse
...
func (o *WebTrendsQueryResponse) SetClickhouseNil() {
...
func (o *WebTrendsQueryResponse) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *WebTrendsQueryResponse) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o *WebTrendsQueryResponse) SetHogqlNil() {
	o.Hogql.Set(nil)
}
...
func (o *WebTrendsQueryResponse) SetLimitNil() {
	o.Limit.Set(nil)
}
...
func (o *WebTrendsQueryResponse) SetOffsetNil() {
	o.Offset.Set(nil)
}
...
func (o *WebTrendsQueryResponse) SetQueryNil() {
	o.Query.Set(nil)
}
...
func (o *WebTrendsQueryResponse) SetUsedPreAggregatedTablesNil() {
...
func (o WebTrendsQueryResponse) MarshalJSON() ([]byte, error) {
...
func (o WebTrendsQueryResponse) ToMap() (map[string]interface{}, error) {
...
func (o *WebTrendsQueryResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varWebTrendsQueryResponse := _WebTrendsQueryResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWebTrendsQueryResponse)

	if err != nil {
		return err
	}

	*o = WebTrendsQueryResponse(varWebTrendsQueryResponse)

	return err
}

type NullableWebTrendsQueryResponse struct {
	value *WebTrendsQueryResponse
	isSet bool
}

func (v NullableWebTrendsQueryResponse) Get() *WebTrendsQueryResponse {
	return v.value
}

func (v *NullableWebTrendsQueryResponse) Set(val *WebTrendsQueryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWebTrendsQueryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWebTrendsQueryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebTrendsQueryResponse(val *WebTrendsQueryResponse) *NullableWebTrendsQueryResponse {
	return &NullableWebTrendsQueryResponse{value: val, isSet: true}
}

func (v NullableWebTrendsQueryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebTrendsQueryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
