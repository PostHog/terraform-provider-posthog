...
// EventTypeEnum * `$ai_generation` - $ai_generation * `$ai_span` - $ai_span * `$ai_embedding` - $ai_embedding * `$ai_trace` - $ai_trace
type EventTypeEnum string

// List of EventTypeEnum
const (
	_AI_GENERATION EventTypeEnum = "$ai_generation"
	_AI_SPAN EventTypeEnum = "$ai_span"
	_AI_EMBEDDING EventTypeEnum = "$ai_embedding"
	_AI_TRACE EventTypeEnum = "$ai_trace"
)
