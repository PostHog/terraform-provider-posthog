...
// checks if the Response5 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Response5{}

// Response5 struct for Response5
...
func (o *Response5) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o *Response5) SetUsedPreAggregatedTablesNil() {
...
func (o Response5) MarshalJSON() ([]byte, error) {
...
func (o Response5) ToMap() (map[string]interface{}, error) {
...
func (o *Response5) UnmarshalJSON(data []byte) (err error) {
	...
	varResponse5 := _Response5{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponse5)

	if err != nil {
		return err
	}

	*o = Response5(varResponse5)

	return err
}

type NullableResponse5 struct {
	value *Response5
	isSet bool
}

func (v NullableResponse5) Get() *Response5 {
	return v.value
}

func (v *NullableResponse5) Set(val *Response5) {
	v.value = val
	v.isSet = true
}

func (v NullableResponse5) IsSet() bool {
	return v.isSet
}

func (v *NullableResponse5) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponse5(val *Response5) *NullableResponse5 {
	return &NullableResponse5{value: val, isSet: true}
}

func (v NullableResponse5) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponse5) UnmarshalJSON(src []byte) error {
	v.isSet = true
