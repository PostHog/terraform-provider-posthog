...
// checks if the HogQLASTQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HogQLASTQuery{}

// HogQLASTQuery struct for HogQLASTQuery
type HogQLASTQuery struct {
...
type _HogQLASTQuery HogQLASTQuery
...
func (o *HogQLASTQuery) SetExplainNil() {
	o.Explain.Set(nil)
}
...
func (o *HogQLASTQuery) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *HogQLASTQuery) SetVersionNil() {
	o.Version.Set(nil)
}
...
func (o HogQLASTQuery) MarshalJSON() ([]byte, error) {
...
func (o HogQLASTQuery) ToMap() (map[string]interface{}, error) {
...
func (o *HogQLASTQuery) UnmarshalJSON(data []byte) (err error) {
	...
	varHogQLASTQuery := _HogQLASTQuery{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHogQLASTQuery)

	if err != nil {
		return err
	}

	*o = HogQLASTQuery(varHogQLASTQuery)

	return err
}

type NullableHogQLASTQuery struct {
	value *HogQLASTQuery
	isSet bool
}

func (v NullableHogQLASTQuery) Get() *HogQLASTQuery {
	return v.value
}

func (v *NullableHogQLASTQuery) Set(val *HogQLASTQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableHogQLASTQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableHogQLASTQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHogQLASTQuery(val *HogQLASTQuery) *NullableHogQLASTQuery {
	return &NullableHogQLASTQuery{value: val, isSet: true}
}

func (v NullableHogQLASTQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHogQLASTQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true
