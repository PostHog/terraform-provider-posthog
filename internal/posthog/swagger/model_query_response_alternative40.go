...
// checks if the QueryResponseAlternative40 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryResponseAlternative40{}

// QueryResponseAlternative40 struct for QueryResponseAlternative40
...
type _QueryResponseAlternative40 QueryResponseAlternative40
...
func NewQueryResponseAlternative40(results []interface{}) *QueryResponseAlternative40 {
	this := QueryResponseAlternative40{}
...
func (o *QueryResponseAlternative40) SetClickhouseNil() {
...
func (o *QueryResponseAlternative40) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *QueryResponseAlternative40) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o *QueryResponseAlternative40) SetHogqlNil() {
	o.Hogql.Set(nil)
}
...
func (o *QueryResponseAlternative40) SetLimitNil() {
	o.Limit.Set(nil)
}
...
func (o *QueryResponseAlternative40) SetOffsetNil() {
	o.Offset.Set(nil)
}
...
func (o *QueryResponseAlternative40) SetQueryNil() {
	o.Query.Set(nil)
}
...
func (o QueryResponseAlternative40) MarshalJSON() ([]byte, error) {
...
func (o QueryResponseAlternative40) ToMap() (map[string]interface{}, error) {
...
func (o *QueryResponseAlternative40) UnmarshalJSON(data []byte) (err error) {
	...
	varQueryResponseAlternative40 := _QueryResponseAlternative40{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varQueryResponseAlternative40)

	if err != nil {
		return err
	}

	*o = QueryResponseAlternative40(varQueryResponseAlternative40)

	return err
}

type NullableQueryResponseAlternative40 struct {
	value *QueryResponseAlternative40
	isSet bool
}

func (v NullableQueryResponseAlternative40) Get() *QueryResponseAlternative40 {
	return v.value
}

func (v *NullableQueryResponseAlternative40) Set(val *QueryResponseAlternative40) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryResponseAlternative40) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryResponseAlternative40) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryResponseAlternative40(val *QueryResponseAlternative40) *NullableQueryResponseAlternative40 {
	return &NullableQueryResponseAlternative40{value: val, isSet: true}
}

func (v NullableQueryResponseAlternative40) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryResponseAlternative40) UnmarshalJSON(src []byte) error {
	v.isSet = true
