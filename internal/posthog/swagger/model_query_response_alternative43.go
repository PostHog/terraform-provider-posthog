...
// checks if the QueryResponseAlternative43 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryResponseAlternative43{}

// QueryResponseAlternative43 struct for QueryResponseAlternative43
...
type _QueryResponseAlternative43 QueryResponseAlternative43
...
func NewQueryResponseAlternative43(results []interface{}) *QueryResponseAlternative43 {
	this := QueryResponseAlternative43{}
...
func (o *QueryResponseAlternative43) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *QueryResponseAlternative43) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o *QueryResponseAlternative43) SetHogqlNil() {
	o.Hogql.Set(nil)
}
...
func (o *QueryResponseAlternative43) SetLimitNil() {
	o.Limit.Set(nil)
}
...
func (o *QueryResponseAlternative43) SetOffsetNil() {
	o.Offset.Set(nil)
}
...
func (o QueryResponseAlternative43) MarshalJSON() ([]byte, error) {
...
func (o QueryResponseAlternative43) ToMap() (map[string]interface{}, error) {
...
func (o *QueryResponseAlternative43) UnmarshalJSON(data []byte) (err error) {
	...
	varQueryResponseAlternative43 := _QueryResponseAlternative43{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varQueryResponseAlternative43)

	if err != nil {
		return err
	}

	*o = QueryResponseAlternative43(varQueryResponseAlternative43)

	return err
}

type NullableQueryResponseAlternative43 struct {
	value *QueryResponseAlternative43
	isSet bool
}

func (v NullableQueryResponseAlternative43) Get() *QueryResponseAlternative43 {
	return v.value
}

func (v *NullableQueryResponseAlternative43) Set(val *QueryResponseAlternative43) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryResponseAlternative43) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryResponseAlternative43) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryResponseAlternative43(val *QueryResponseAlternative43) *NullableQueryResponseAlternative43 {
	return &NullableQueryResponseAlternative43{value: val, isSet: true}
}

func (v NullableQueryResponseAlternative43) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryResponseAlternative43) UnmarshalJSON(src []byte) error {
	v.isSet = true
