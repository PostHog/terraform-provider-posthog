...
// checks if the QueryResponseAlternative24 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryResponseAlternative24{}

// QueryResponseAlternative24 struct for QueryResponseAlternative24
...
type _QueryResponseAlternative24 QueryResponseAlternative24
...
func NewQueryResponseAlternative24(results []interface{}) *QueryResponseAlternative24 {
	this := QueryResponseAlternative24{}
...
func (o *QueryResponseAlternative24) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *QueryResponseAlternative24) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o *QueryResponseAlternative24) SetHogqlNil() {
	o.Hogql.Set(nil)
}
...
func (o *QueryResponseAlternative24) SetLimitNil() {
	o.Limit.Set(nil)
}
...
func (o *QueryResponseAlternative24) SetOffsetNil() {
	o.Offset.Set(nil)
}
...
func (o *QueryResponseAlternative24) SetUsedPreAggregatedTablesNil() {
...
func (o QueryResponseAlternative24) MarshalJSON() ([]byte, error) {
...
func (o QueryResponseAlternative24) ToMap() (map[string]interface{}, error) {
...
func (o *QueryResponseAlternative24) UnmarshalJSON(data []byte) (err error) {
	...
	varQueryResponseAlternative24 := _QueryResponseAlternative24{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varQueryResponseAlternative24)

	if err != nil {
		return err
	}

	*o = QueryResponseAlternative24(varQueryResponseAlternative24)

	return err
}

type NullableQueryResponseAlternative24 struct {
	value *QueryResponseAlternative24
	isSet bool
}

func (v NullableQueryResponseAlternative24) Get() *QueryResponseAlternative24 {
	return v.value
}

func (v *NullableQueryResponseAlternative24) Set(val *QueryResponseAlternative24) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryResponseAlternative24) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryResponseAlternative24) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryResponseAlternative24(val *QueryResponseAlternative24) *NullableQueryResponseAlternative24 {
	return &NullableQueryResponseAlternative24{value: val, isSet: true}
}

func (v NullableQueryResponseAlternative24) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryResponseAlternative24) UnmarshalJSON(src []byte) error {
	v.isSet = true
