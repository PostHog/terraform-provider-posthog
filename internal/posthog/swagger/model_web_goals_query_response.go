...
// checks if the WebGoalsQueryResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebGoalsQueryResponse{}

// WebGoalsQueryResponse struct for WebGoalsQueryResponse
...
type _WebGoalsQueryResponse WebGoalsQueryResponse
...
func (o *WebGoalsQueryResponse) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *WebGoalsQueryResponse) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o *WebGoalsQueryResponse) SetHogqlNil() {
	o.Hogql.Set(nil)
}
...
func (o *WebGoalsQueryResponse) SetLimitNil() {
	o.Limit.Set(nil)
}
...
func (o *WebGoalsQueryResponse) SetOffsetNil() {
	o.Offset.Set(nil)
}
...
func (o WebGoalsQueryResponse) MarshalJSON() ([]byte, error) {
...
func (o WebGoalsQueryResponse) ToMap() (map[string]interface{}, error) {
...
func (o *WebGoalsQueryResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varWebGoalsQueryResponse := _WebGoalsQueryResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWebGoalsQueryResponse)

	if err != nil {
		return err
	}

	*o = WebGoalsQueryResponse(varWebGoalsQueryResponse)

	return err
}

type NullableWebGoalsQueryResponse struct {
	value *WebGoalsQueryResponse
	isSet bool
}

func (v NullableWebGoalsQueryResponse) Get() *WebGoalsQueryResponse {
	return v.value
}

func (v *NullableWebGoalsQueryResponse) Set(val *WebGoalsQueryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWebGoalsQueryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWebGoalsQueryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebGoalsQueryResponse(val *WebGoalsQueryResponse) *NullableWebGoalsQueryResponse {
	return &NullableWebGoalsQueryResponse{value: val, isSet: true}
}

func (v NullableWebGoalsQueryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebGoalsQueryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
