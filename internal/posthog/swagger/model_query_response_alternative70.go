...
// checks if the QueryResponseAlternative70 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryResponseAlternative70{}

// QueryResponseAlternative70 struct for QueryResponseAlternative70
...
type _QueryResponseAlternative70 QueryResponseAlternative70
...
func NewQueryResponseAlternative70(results interface{}) *QueryResponseAlternative70 {
	this := QueryResponseAlternative70{}
...
func (o *QueryResponseAlternative70) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *QueryResponseAlternative70) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o *QueryResponseAlternative70) SetHogqlNil() {
	o.Hogql.Set(nil)
}
...
func (o *QueryResponseAlternative70) SetLimitNil() {
	o.Limit.Set(nil)
}
...
func (o *QueryResponseAlternative70) SetOffsetNil() {
	o.Offset.Set(nil)
}
...
func (o QueryResponseAlternative70) MarshalJSON() ([]byte, error) {
...
func (o QueryResponseAlternative70) ToMap() (map[string]interface{}, error) {
...
func (o *QueryResponseAlternative70) UnmarshalJSON(data []byte) (err error) {
	...
	varQueryResponseAlternative70 := _QueryResponseAlternative70{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varQueryResponseAlternative70)

	if err != nil {
		return err
	}

	*o = QueryResponseAlternative70(varQueryResponseAlternative70)

	return err
}

type NullableQueryResponseAlternative70 struct {
	value *QueryResponseAlternative70
	isSet bool
}

func (v NullableQueryResponseAlternative70) Get() *QueryResponseAlternative70 {
	return v.value
}

func (v *NullableQueryResponseAlternative70) Set(val *QueryResponseAlternative70) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryResponseAlternative70) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryResponseAlternative70) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryResponseAlternative70(val *QueryResponseAlternative70) *NullableQueryResponseAlternative70 {
	return &NullableQueryResponseAlternative70{value: val, isSet: true}
}

func (v NullableQueryResponseAlternative70) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryResponseAlternative70) UnmarshalJSON(src []byte) error {
	v.isSet = true
