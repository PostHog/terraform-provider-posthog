...
// checks if the WebStatsTableQueryResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebStatsTableQueryResponse{}

// WebStatsTableQueryResponse struct for WebStatsTableQueryResponse
...
type _WebStatsTableQueryResponse WebStatsTableQueryResponse
...
func NewWebStatsTableQueryResponse(results []interface{}) *WebStatsTableQueryResponse {
	this := WebStatsTableQueryResponse{}
...
func (o *WebStatsTableQueryResponse) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *WebStatsTableQueryResponse) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o *WebStatsTableQueryResponse) SetHogqlNil() {
	o.Hogql.Set(nil)
}
...
func (o *WebStatsTableQueryResponse) SetLimitNil() {
	o.Limit.Set(nil)
}
...
func (o *WebStatsTableQueryResponse) SetOffsetNil() {
	o.Offset.Set(nil)
}
...
func (o *WebStatsTableQueryResponse) SetUsedPreAggregatedTablesNil() {
...
func (o WebStatsTableQueryResponse) MarshalJSON() ([]byte, error) {
...
func (o WebStatsTableQueryResponse) ToMap() (map[string]interface{}, error) {
...
func (o *WebStatsTableQueryResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varWebStatsTableQueryResponse := _WebStatsTableQueryResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWebStatsTableQueryResponse)

	if err != nil {
		return err
	}

	*o = WebStatsTableQueryResponse(varWebStatsTableQueryResponse)

	return err
}

type NullableWebStatsTableQueryResponse struct {
	value *WebStatsTableQueryResponse
	isSet bool
}

func (v NullableWebStatsTableQueryResponse) Get() *WebStatsTableQueryResponse {
	return v.value
}

func (v *NullableWebStatsTableQueryResponse) Set(val *WebStatsTableQueryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWebStatsTableQueryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWebStatsTableQueryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebStatsTableQueryResponse(val *WebStatsTableQueryResponse) *NullableWebStatsTableQueryResponse {
	return &NullableWebStatsTableQueryResponse{value: val, isSet: true}
}

func (v NullableWebStatsTableQueryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebStatsTableQueryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
