...
// checks if the Response6 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Response6{}

// Response6 struct for Response6
...
func (o *Response6) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o Response6) MarshalJSON() ([]byte, error) {
...
func (o Response6) ToMap() (map[string]interface{}, error) {
...
func (o *Response6) UnmarshalJSON(data []byte) (err error) {
	...
	varResponse6 := _Response6{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponse6)

	if err != nil {
		return err
	}

	*o = Response6(varResponse6)

	return err
}

type NullableResponse6 struct {
	value *Response6
	isSet bool
}

func (v NullableResponse6) Get() *Response6 {
	return v.value
}

func (v *NullableResponse6) Set(val *Response6) {
	v.value = val
	v.isSet = true
}

func (v NullableResponse6) IsSet() bool {
	return v.isSet
}

func (v *NullableResponse6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponse6(val *Response6) *NullableResponse6 {
	return &NullableResponse6{value: val, isSet: true}
}

func (v NullableResponse6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponse6) UnmarshalJSON(src []byte) error {
	v.isSet = true
