...
// checks if the QueryResponseAlternative1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryResponseAlternative1{}

// QueryResponseAlternative1 struct for QueryResponseAlternative1
...
type _QueryResponseAlternative1 QueryResponseAlternative1
...
func NewQueryResponseAlternative1(columns []interface{}, hogql string, results [][]interface{}, types []string) *QueryResponseAlternative1 {
	this := QueryResponseAlternative1{}
...
func (o *QueryResponseAlternative1) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *QueryResponseAlternative1) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o *QueryResponseAlternative1) SetLimitNil() {
	o.Limit.Set(nil)
}
...
func (o *QueryResponseAlternative1) SetOffsetNil() {
	o.Offset.Set(nil)
}
...
func (o QueryResponseAlternative1) MarshalJSON() ([]byte, error) {
...
func (o QueryResponseAlternative1) ToMap() (map[string]interface{}, error) {
...
func (o *QueryResponseAlternative1) UnmarshalJSON(data []byte) (err error) {
	...
	varQueryResponseAlternative1 := _QueryResponseAlternative1{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varQueryResponseAlternative1)

	if err != nil {
		return err
	}

	*o = QueryResponseAlternative1(varQueryResponseAlternative1)

	return err
}

type NullableQueryResponseAlternative1 struct {
	value *QueryResponseAlternative1
	isSet bool
}

func (v NullableQueryResponseAlternative1) Get() *QueryResponseAlternative1 {
	return v.value
}

func (v *NullableQueryResponseAlternative1) Set(val *QueryResponseAlternative1) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryResponseAlternative1) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryResponseAlternative1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryResponseAlternative1(val *QueryResponseAlternative1) *NullableQueryResponseAlternative1 {
	return &NullableQueryResponseAlternative1{value: val, isSet: true}
}

func (v NullableQueryResponseAlternative1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryResponseAlternative1) UnmarshalJSON(src []byte) error {
	v.isSet = true
