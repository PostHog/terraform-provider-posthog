...
// checks if the QueryResponseAlternative55 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryResponseAlternative55{}

// QueryResponseAlternative55 struct for QueryResponseAlternative55
...
type _QueryResponseAlternative55 QueryResponseAlternative55
...
func NewQueryResponseAlternative55(results [][]MarketingAnalyticsItem) *QueryResponseAlternative55 {
	this := QueryResponseAlternative55{}
...
func (o *QueryResponseAlternative55) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *QueryResponseAlternative55) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o *QueryResponseAlternative55) SetHogqlNil() {
	o.Hogql.Set(nil)
}
...
func (o *QueryResponseAlternative55) SetLimitNil() {
	o.Limit.Set(nil)
}
...
func (o *QueryResponseAlternative55) SetOffsetNil() {
	o.Offset.Set(nil)
}
...
func (o QueryResponseAlternative55) MarshalJSON() ([]byte, error) {
...
func (o QueryResponseAlternative55) ToMap() (map[string]interface{}, error) {
...
func (o *QueryResponseAlternative55) UnmarshalJSON(data []byte) (err error) {
	...
	varQueryResponseAlternative55 := _QueryResponseAlternative55{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varQueryResponseAlternative55)

	if err != nil {
		return err
	}

	*o = QueryResponseAlternative55(varQueryResponseAlternative55)

	return err
}

type NullableQueryResponseAlternative55 struct {
	value *QueryResponseAlternative55
	isSet bool
}

func (v NullableQueryResponseAlternative55) Get() *QueryResponseAlternative55 {
	return v.value
}

func (v *NullableQueryResponseAlternative55) Set(val *QueryResponseAlternative55) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryResponseAlternative55) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryResponseAlternative55) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryResponseAlternative55(val *QueryResponseAlternative55) *NullableQueryResponseAlternative55 {
	return &NullableQueryResponseAlternative55{value: val, isSet: true}
}

func (v NullableQueryResponseAlternative55) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryResponseAlternative55) UnmarshalJSON(src []byte) error {
	v.isSet = true
