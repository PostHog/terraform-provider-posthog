...
// checks if the DesktopRecording type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DesktopRecording{}

// DesktopRecording struct for DesktopRecording
...
type _DesktopRecording DesktopRecording
...
func (o *DesktopRecording) SetRecallRecordingIdNil() {
...
func (o *DesktopRecording) SetMeetingTitleNil() {
...
func (o *DesktopRecording) SetMeetingUrlNil() {
...
func (o *DesktopRecording) SetDurationSecondsNil() {
...
func (o *DesktopRecording) SetNotesNil() {
	o.Notes.Set(nil)
}
...
func (o *DesktopRecording) SetErrorMessageNil() {
...
func (o *DesktopRecording) SetVideoUrlNil() {
	o.VideoUrl.Set(nil)
}
...
func (o *DesktopRecording) SetVideoSizeBytesNil() {
...
func (o *DesktopRecording) SetSummaryNil() {
	o.Summary.Set(nil)
}
...
func (o *DesktopRecording) SetTasksGeneratedAtNil() {
...
func (o *DesktopRecording) SetSummaryGeneratedAtNil() {
...
func (o *DesktopRecording) SetCompletedAtNil() {
...
func (o DesktopRecording) MarshalJSON() ([]byte, error) {
...
func (o DesktopRecording) ToMap() (map[string]interface{}, error) {
...
func (o *DesktopRecording) UnmarshalJSON(data []byte) (err error) {
	...
	varDesktopRecording := _DesktopRecording{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDesktopRecording)

	if err != nil {
		return err
	}

	*o = DesktopRecording(varDesktopRecording)

	return err
}

type NullableDesktopRecording struct {
	value *DesktopRecording
	isSet bool
}

func (v NullableDesktopRecording) Get() *DesktopRecording {
	return v.value
}

func (v *NullableDesktopRecording) Set(val *DesktopRecording) {
	v.value = val
	v.isSet = true
}

func (v NullableDesktopRecording) IsSet() bool {
	return v.isSet
}

func (v *NullableDesktopRecording) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDesktopRecording(val *DesktopRecording) *NullableDesktopRecording {
	return &NullableDesktopRecording{value: val, isSet: true}
}

func (v NullableDesktopRecording) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDesktopRecording) UnmarshalJSON(src []byte) error {
	v.isSet = true
