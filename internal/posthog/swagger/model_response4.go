...
// checks if the Response4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Response4{}

// Response4 struct for Response4
...
func (o *Response4) SetDateFromNil() {
	o.DateFrom.Set(nil)
}
...
func (o *Response4) SetUsedPreAggregatedTablesNil() {
...
func (o Response4) MarshalJSON() ([]byte, error) {
...
func (o Response4) ToMap() (map[string]interface{}, error) {
...
func (o *Response4) UnmarshalJSON(data []byte) (err error) {
	...
	varResponse4 := _Response4{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponse4)

	if err != nil {
		return err
	}

	*o = Response4(varResponse4)

	return err
}

type NullableResponse4 struct {
	value *Response4
	isSet bool
}

func (v NullableResponse4) Get() *Response4 {
	return v.value
}

func (v *NullableResponse4) Set(val *Response4) {
	v.value = val
	v.isSet = true
}

func (v NullableResponse4) IsSet() bool {
	return v.isSet
}

func (v *NullableResponse4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponse4(val *Response4) *NullableResponse4 {
	return &NullableResponse4{value: val, isSet: true}
}

func (v NullableResponse4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponse4) UnmarshalJSON(src []byte) error {
	v.isSet = true
