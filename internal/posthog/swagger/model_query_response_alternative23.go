...
// checks if the QueryResponseAlternative23 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QueryResponseAlternative23{}

// QueryResponseAlternative23 struct for QueryResponseAlternative23
...
type _QueryResponseAlternative23 QueryResponseAlternative23
...
func NewQueryResponseAlternative23(results []WebOverviewItem) *QueryResponseAlternative23 {
	this := QueryResponseAlternative23{}
...
func (o *QueryResponseAlternative23) SetDateFromNil() {
	o.DateFrom.Set(nil)
}
...
func (o *QueryResponseAlternative23) SetDateToNil() {
	o.DateTo.Set(nil)
}
...
func (o *QueryResponseAlternative23) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *QueryResponseAlternative23) SetHogqlNil() {
	o.Hogql.Set(nil)
}
...
func (o *QueryResponseAlternative23) SetUsedPreAggregatedTablesNil() {
...
func (o QueryResponseAlternative23) MarshalJSON() ([]byte, error) {
...
func (o QueryResponseAlternative23) ToMap() (map[string]interface{}, error) {
...
func (o *QueryResponseAlternative23) UnmarshalJSON(data []byte) (err error) {
	...
	varQueryResponseAlternative23 := _QueryResponseAlternative23{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varQueryResponseAlternative23)

	if err != nil {
		return err
	}

	*o = QueryResponseAlternative23(varQueryResponseAlternative23)

	return err
}

type NullableQueryResponseAlternative23 struct {
	value *QueryResponseAlternative23
	isSet bool
}

func (v NullableQueryResponseAlternative23) Get() *QueryResponseAlternative23 {
	return v.value
}

func (v *NullableQueryResponseAlternative23) Set(val *QueryResponseAlternative23) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryResponseAlternative23) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryResponseAlternative23) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryResponseAlternative23(val *QueryResponseAlternative23) *NullableQueryResponseAlternative23 {
	return &NullableQueryResponseAlternative23{value: val, isSet: true}
}

func (v NullableQueryResponseAlternative23) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryResponseAlternative23) UnmarshalJSON(src []byte) error {
	v.isSet = true
