...
// checks if the SessionsQueryResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SessionsQueryResponse{}

// SessionsQueryResponse struct for SessionsQueryResponse
...
type _SessionsQueryResponse SessionsQueryResponse
...
func (o *SessionsQueryResponse) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *SessionsQueryResponse) SetHasMoreNil() {
	o.HasMore.Set(nil)
}
...
func (o *SessionsQueryResponse) SetLimitNil() {
	o.Limit.Set(nil)
}
...
func (o *SessionsQueryResponse) SetOffsetNil() {
	o.Offset.Set(nil)
}
...
func (o SessionsQueryResponse) MarshalJSON() ([]byte, error) {
...
func (o SessionsQueryResponse) ToMap() (map[string]interface{}, error) {
...
func (o *SessionsQueryResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSessionsQueryResponse := _SessionsQueryResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSessionsQueryResponse)

	if err != nil {
		return err
	}

	*o = SessionsQueryResponse(varSessionsQueryResponse)

	return err
}

type NullableSessionsQueryResponse struct {
	value *SessionsQueryResponse
	isSet bool
}

func (v NullableSessionsQueryResponse) Get() *SessionsQueryResponse {
	return v.value
}

func (v *NullableSessionsQueryResponse) Set(val *SessionsQueryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSessionsQueryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSessionsQueryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSessionsQueryResponse(val *SessionsQueryResponse) *NullableSessionsQueryResponse {
	return &NullableSessionsQueryResponse{value: val, isSet: true}
}

func (v NullableSessionsQueryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSessionsQueryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
